  ...
  try {
    ...
    const doctors = await Doctor.find()
      ...
      .populate({
        ...
        select: 'dayOfWeek startTime endTime createdAt updatedAt', // Seleccionamos los campos necesarios, incluyendo las fechas
      });
    ...
    doctors.forEach((doctor) => {
      ...
      const specialtyNames = doctor.specialties.map(
        ...
        specialtyNames.forEach((specialtyName) => {
          ...
          if (specialtyObj) {
            specialtyObj.horarios.push({
              ...
              createdAt: schedule.createdAt, // Agregamos la fecha de creación
              updatedAt: schedule.updatedAt, // Agregamos la fecha de actualización
            });
          }
        });
      });
