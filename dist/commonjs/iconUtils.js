...
var generateSvg = function generateSvg() {
  var color = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '#f06';
  var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
  return "<svg width=\"".concat(size, "\" height=\"").concat(size, "\" xmlns=\"http://www.w3.org/2000/svg\">\n            <circle cx=\"").concat(size / 2, "\" cy=\"").concat(size / 2, "\" r=\"").concat(size / 4, "\" fill=\"").concat(color, "\" />\n          </svg>");
};
var getIcon = function getIcon(iconName) {
  var icons = _defineProperty({
    ...
    logout: "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"icon\" viewBox=\"0 0 24 24\" width=\"24\" height=\"24\"><path d=\"M10 17l5-5-5-5v4H0v2h10v4zM22 4H6v2h16v12H6v2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z\"/></svg>",
    agendar: "<svg class=\"icon\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19 3h-1V1h-2v2H8V1H6v2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H5V8h14v13zm-7-3h-2v-2h2v2zm0-4h-2V8h2v6z\"/></svg>",
    practices: "<svg class=\"icon\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M3 3h18v2H3V3zm0 4h18v2H3V7zm0 4h18v2H3v-2zm0 4h18v2H3v-2zm0 4h18v2H3v-2z\"/></svg>",
    doctors: "<svg class=\"icon\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M12 2c-1.1 0-2 .9-2 2v8H6c-1.1 0-2 .9-2 2v4h4v4h4v-4h4v-4h4v-4c0-1.1-.9-2-2-2h-4V4c0-1.1-.9-2-2-2z\"/></svg>",
    schedule: "<svg class=\"icon\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19 3h-1V1h-2v2H8V1H6v2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H5V8h14v13zm-7-3h-2v-2h2v2zm0-4h-2V8h2v6z\"/></svg>",
...
var generateIdFromPath = function generateIdFromPath(path) {
  return path.replace(/\//g, '-').replace(/[^a-z0-9-]/gi, '').toLowerCase();
};
var validateIcon = function validateIcon(iconName) {
