...
var generateRandomClinicIcon = exports.generateRandomClinicIcon = function generateRandomClinicIcon(title) {
  ...
  } else if (title.includes('Cita') || title.includes('Horario') || title.includes('Disponibilidad')) {
    iconListKey = 'appointmentIcons'; // Rutas relacionadas con citas y horarios
  } else if (title.includes('Usuario') || title.includes('Rol') || title.includes('Permiso')) {
