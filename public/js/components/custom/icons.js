$(document).ready(function () {
  // Definimos los íconos como cadenas SVG
  ...
  const icons = {
    ...
    // Nuevos íconos para la clínica
    appointment: `<svg class="icon" viewBox="0 0 24 24"><path d="M3 8h18v13H3V8zm5-6h2v3H8V2zm5 0h2v3h-2V2zm5 0h2v3h-2V2z"/></svg>`, // Ícono de Citas
    doctor: `<svg class="icon" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-3.31 0-10 1.67-10 5v3h20v-3c0-3.33-6.69-5-10-5z"/></svg>`, // Ícono de Doctores
    patient: `<svg class="icon" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-3.31 0-10 1.67-10 5v3h20v-3c0-3.33-6.69-5-10-5z"/></svg>`, // Ícono de Pacientes
  };
  // console.log(icons);

  // Función para agregar íconos al contenedor
