export function openModal (modalId, size, title, backgroundColor) {
  ...
  // Cambiar el color de fondo si se pasa un valor
  if (backgroundColor) {
...
export function closeModal (modalId) {
  ...
  setTimeout(() => {
    ...
    // Si deseas limpiar el color de fondo, puedes hacerlo aquí
    // modalContent.style.backgroundColor = ''; // Esto restauraría el fondo original
