...
export const componentsEndpoints = {
  list: `${BASE_URL}/components/api`,
  create: `${BASE_URL}/components/create-component`,
  update: `${BASE_URL}/components/update-component`,
  delete: `${BASE_URL}/components/delete`,
  deleteMultiple: `${BASE_URL}/components/delete-multiple`,
};
