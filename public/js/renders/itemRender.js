...
export const getHeadersForRole = (role, currentView) => {
  // Base común de encabezados
  let headers = ['Nombre Completo']; // Solo nombre en modo 'card'

  // Si no es 'card', agregamos los otros campos
  if (currentView !== 'card') {
    headers.push('Correo', 'Género', 'Roles');
