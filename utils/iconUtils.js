...
const getIcon = (iconName) => {
 const icons = {
   ...
   logout: `<svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 24 24" width="24" height="24">
<path d="M10 17l5-5-5-5v4H0v2h10v4zM22 4H6v2h16v12H6v2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>
`,
 };
